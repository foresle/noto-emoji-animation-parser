...
image_format = "webp"  # Default image format
if args.gif:
    image_format = "gif"
elif args.webp:
    image_format = "webp"
...
all_emojis_links: dict = {
    code: {
        "url": f"https://fonts.gstatic.com/s/e/notoemoji/latest/{hex(code)[2:]}/512.{image_format}",
        "file_name": f"{description}.{image_format}",
    }
